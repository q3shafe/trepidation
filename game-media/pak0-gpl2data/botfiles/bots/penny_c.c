...
skill 1
{
	CHARACTERISTIC_NAME							"Penny"
	CHARACTERISTIC_GENDER						"it"
	CHARACTERISTIC_ATTACK_SKILL					0.25
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/penny_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/penny_t.c"
	CHARACTERISTIC_CHAT_NAME					"penny"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/penny_i.c"
