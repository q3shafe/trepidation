...
<html>
<head>
	<title>Trepidation, A retro first person shooter</title>
	<meta charset="UTF-8">
	...
	<header>
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<div class="container mx-auto">
				<a class="navbar-brand" href="#">Trepidation FPS</a>
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						...
						<li class="nav-item">
							<a class="nav-link" target="_new" href="https://github.com/q3shafe/trepidation">GitHub</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" target="_new" href="https://trepidationfps.com/dls/trep-snapshot.zip">Nightly Build</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" target="_new" href="https://github.com/q3shafe/trepidation/blob/master/Docs/CHANGELOG.TXT">Changelog</a>
						</li>
					</ul>
				</div>
			</div>
