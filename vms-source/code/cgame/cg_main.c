...
static cvarTable_t cvarTable[] = { // bk001129
	...
	{ &cg_zoomFov, "cg_zoomfov", "15.5", CVAR_ARCHIVE },
...
#endif
	{ &cg_hudFiles, "cg_hudFiles", "ui/hud.txt", CVAR_ARCHIVE}, // Shafe - Trep
...
static void CG_RegisterSounds( void ) {
	...
	cgs.media.zoomStart = trap_S_RegisterSound( "sound/world/electro.ogg", qtrue );
	cgs.media.zoomEnd = trap_S_RegisterSound( "sound/world/electro.ogg", qtrue );
	


#ifdef MISSIONPACK
	cgs.media.countPrepareTeamSound = trap_S_RegisterSound( "sound/feedback/prepare_team.ogg", qtrue );
#endif
	...
	cgs.media.glassSound = trap_S_RegisterSound( "sound/world/glassbreak.ogg", qfalse );
	cgs.media.errorSound = trap_S_RegisterSound( "sound/misc/error.ogg", qfalse );
	...
	cgs.media.invulnerabilityJuicedSound = trap_S_RegisterSound( "sound/items/invul_juiced.ogg", qfalse );
	...
	cgs.media.ammoregenSound = trap_S_RegisterSound("sound/items/cl_ammoregen.ogg", qfalse);
	cgs.media.doublerSound = trap_S_RegisterSound("sound/items/cl_doubler.ogg", qfalse);
	cgs.media.guardSound = trap_S_RegisterSound("sound/items/cl_guard.ogg", qfalse);
	cgs.media.scoutSound = trap_S_RegisterSound("sound/items/cl_scout.ogg", qfalse);
#endif
...
//		}
	...
	cgs.media.turretFireShader = trap_R_RegisterShader( "sprites/turretfire" );
	...
	cgs.media.hplb1aSound = trap_S_RegisterSound("sound/weapons/plasma/hplb1a.wav", qfalse);
	cgs.media.hplb2aSound = trap_S_RegisterSound("sound/weapons/plasma/hplb2a.wav", qfalse);
...
static void CG_RegisterGraphics( void ) {
	...
	cgs.media.smokePuffRageProShader2 = trap_R_RegisterShader( "smokePuffRagePro2" );
	// End Shafe
	...
	cgs.media.sgTrailShader = trap_R_RegisterShader( "sgTrail" );
	...
	// -Vincent
	cgs.media.immobilizedShader	= trap_R_RegisterShader("powerups/immobilized" );
	cgs.media.immobilizedWepShader = trap_R_RegisterShader("powerups/immobilizedWeapon" );
