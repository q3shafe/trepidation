...
proc CG_DrawInformation 1140 36
line 156
;147:
;148:
;149:/*
...
;311:		s = "Overload";
;312:		break;
;313:	case GT_HARVESTER:
;314:		s = "Harvester";
;315:		break;
;316:#endif
;317:	default:
;318:		s = "Unknown Gametype";
ADDRLP4 0
ADDRGP4 $186
ASGNP4
line 319
...
line 321
;320:	}
;321:	UI_DrawProportionalString( 320, y, s,
CNSTI4 320
ARGI4
ADDRLP4 4
INDIRI4
...
pop
line 323
;322:		UI_LEFT|UI_SMALLFONT|UI_DROPSHADOW, colorWhite );
;323:	y += PROP_HEIGHT;
ADDRLP4 4
ADDRLP4 4
INDIRI4
...
line 325
;324:		
;325:	value = atoi( Info_ValueForKey( info, "timelimit" ) );
ADDRLP4 12
INDIRP4
ARGP4
ADDRGP4 $188
...
EQI4 $189
line 327
;327:		UI_DrawProportionalString( 320, y, va( "timelimit %i", value ),
ADDRGP4 $191
ARGP4
ADDRLP4 8
INDIRI4
...
pop
line 329
;328:			UI_LEFT|UI_SMALLFONT|UI_DROPSHADOW, colorWhite );
;329:		y += PROP_HEIGHT;
ADDRLP4 4
ADDRLP4 4
INDIRI4
...
line 332
;331:
;332:	if (cgs.gametype < GT_CTF ) {
ADDRGP4 cgs+31456
INDIRI4
CNSTI4 4
GEI4 $192
line 333
;333:		value = atoi( Info_ValueForKey( info, "fraglimit" ) );
ADDRLP4 12
INDIRP4
ARGP4
ADDRGP4 $195
...
pop
line 337
;336:				UI_LEFT|UI_SMALLFONT|UI_DROPSHADOW, colorWhite );
;337:			y += PROP_HEIGHT;
ADDRLP4 4
ADDRLP4 4
INDIRI4
...
line 341
;340:
;341:	if (cgs.gametype >= GT_CTF) {
ADDRGP4 cgs+31456
INDIRI4
CNSTI4 4
LTI4 $199
line 342
;342:		value = atoi( Info_ValueForKey( info, "capturelimit" ) );
ADDRLP4 12
INDIRP4
ARGP4
ADDRGP4 $202
...
EQI4 $203
line 344
;344:			UI_DrawProportionalString( 320, y, va( "capturelimit %i", value ),
ADDRGP4 $205
ARGP4
ADDRLP4 8
INDIRI4
...
pop
line 346
;345:				UI_LEFT|UI_SMALLFONT|UI_DROPSHADOW, colorWhite );
;346:			y += PROP_HEIGHT;
ADDRLP4 4
ADDRLP4 4
INDIRI4
...
;349:}
LABELV $118
endproc CG_DrawInformation 1140 36
bss
align 4
