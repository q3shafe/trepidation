...
;249:		s = "Overload";
;250:		break;
;251:	case GT_HARVESTER:
;252:		s = "Harvester";
;253:		break;
;254:#endif
;255:	default:
;256:		s = "Unknown Gametype";
ADDRLP4 0
ADDRGP4 $168
ASGNP4
line 257
...
line 259
;258:	}
;259:	UI_DrawProportionalString( 320, y, s,
CNSTI4 320
ARGI4
ADDRLP4 4
INDIRI4
...
line 263
;262:		
;263:	value = atoi( Info_ValueForKey( info, "timelimit" ) );
ADDRLP4 12
INDIRP4
ARGP4
ADDRGP4 $170
...
EQI4 $171
line 265
;265:		UI_DrawProportionalString( 320, y, va( "timelimit %i", value ),
ADDRGP4 $173
ARGP4
ADDRLP4 8
INDIRI4
...
pop
line 267
;266:			UI_CENTER|UI_SMALLFONT|UI_DROPSHADOW, colorWhite );
;267:		y += PROP_HEIGHT;
ADDRLP4 4
ADDRLP4 4
INDIRI4
...
line 270
;269:
;270:	if (cgs.gametype < GT_CTF ) {
ADDRGP4 cgs+31456
INDIRI4
CNSTI4 4
GEI4 $174
line 271
;271:		value = atoi( Info_ValueForKey( info, "fraglimit" ) );
ADDRLP4 12
INDIRP4
ARGP4
ADDRGP4 $177
...
EQI4 $178
line 273
;273:			UI_DrawProportionalString( 320, y, va( "fraglimit %i", value ),
ADDRGP4 $180
ARGP4
ADDRLP4 8
INDIRI4
...
pop
line 275
;274:				UI_CENTER|UI_SMALLFONT|UI_DROPSHADOW, colorWhite );
;275:			y += PROP_HEIGHT;
ADDRLP4 4
ADDRLP4 4
INDIRI4
...
LTI4 $181
line 280
;280:		value = atoi( Info_ValueForKey( info, "capturelimit" ) );
ADDRLP4 12
INDIRP4
ARGP4
ADDRGP4 $184
...
EQI4 $185
line 282
;282:			UI_DrawProportionalString( 320, y, va( "capturelimit %i", value ),
ADDRGP4 $187
ARGP4
ADDRLP4 8
INDIRI4
