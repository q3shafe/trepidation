...
;2072:===============
;2073:*/
;2074:void CG_PlayerSprites( centity_t *cent ) {
line 2079
;2075:	int		team;
;2076:
;2077:
;2078:	// Any Buildable Object That is your team needs a cute little sprite too
;2079:	if (cent->currentState.eType == ET_TURRET)
ADDRFP4 0
INDIRP4
CNSTI4 4
ADDP4
...
;2080:	{
line 2081
;2081:			team = cent->currentState.team;
ADDRLP4 0
ADDRFP4 0
INDIRP4
CNSTI4 208
...
ASGNI4
line 2082
;2082:			if ( cg.snap->ps.persistant[PERS_TEAM] == team) 
ADDRGP4 cg+36
INDIRP4
CNSTI4 304
ADDP4
...
;2083:			{
line 2084
;2084:				CG_PlayerFloatSprite( cent, cgs.media.friendShader );
ADDRFP4 0
INDIRP4
ARGP4
...
;2088:		
;2089:	
;2090:	if ( cent->currentState.eFlags & EF_CONNECTION ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $976
line 2091
;2091:		CG_PlayerFloatSprite( cent, cgs.media.connectionShader );
ADDRFP4 0
INDIRP4
ARGP4
...
;2093:	}
;2094:
;2095:	if ( cent->currentState.eFlags & EF_TALK ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $980
line 2096
;2096:		CG_PlayerFloatSprite( cent, cgs.media.balloonShader );
ADDRFP4 0
INDIRP4
ARGP4
...
;2098:	}
;2099:
;2100:	if ( cent->currentState.eFlags & EF_AWARD_IMPRESSIVE ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $984
line 2101
;2101:		CG_PlayerFloatSprite( cent, cgs.media.medalImpressive );
ADDRFP4 0
INDIRP4
ARGP4
...
;2103:	}
;2104:
;2105:	if ( cent->currentState.eFlags & EF_AWARD_EXCELLENT ) {
ADDRLP4 4
CNSTI4 8
ASGNI4
ADDRFP4 0
...
EQI4 $988
line 2106
;2106:		CG_PlayerFloatSprite( cent, cgs.media.medalExcellent );
ADDRFP4 0
INDIRP4
ARGP4
...
;2108:	}
;2109:
;2110:	if ( cent->currentState.eFlags & EF_AWARD_GAUNTLET ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $992
line 2111
;2111:		CG_PlayerFloatSprite( cent, cgs.media.medalGauntlet );
ADDRFP4 0
INDIRP4
ARGP4
...
;2113:	}
;2114:
;2115:	if ( cent->currentState.eFlags & EF_AWARD_DEFEND ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $996
line 2116
;2116:		CG_PlayerFloatSprite( cent, cgs.media.medalDefend );
ADDRFP4 0
INDIRP4
ARGP4
...
;2118:	}
;2119:
;2120:	if ( cent->currentState.eFlags & EF_AWARD_ASSIST ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $1000
line 2121
;2121:		CG_PlayerFloatSprite( cent, cgs.media.medalAssist );
ADDRFP4 0
INDIRP4
ARGP4
...
;2123:	}
;2124:
;2125:	if ( cent->currentState.eFlags & EF_AWARD_CAP ) {
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
EQI4 $1004
line 2126
;2126:		CG_PlayerFloatSprite( cent, cgs.media.medalCapture );
ADDRFP4 0
INDIRP4
ARGP4
...
;2128:	}
;2129:
;2130:	team = cgs.clientinfo[ cent->currentState.clientNum ].team;
ADDRLP4 0
CNSTI4 1732
ADDRFP4 0
INDIRP4
...
line 2132
;2131:
;2132:	if ( !(cent->currentState.eFlags & EF_DEAD) && 
ADDRFP4 0
INDIRP4
CNSTI4 8
ADDP4
...
LTI4 $1010
line 2134
;2133:		cg.snap->ps.persistant[PERS_TEAM] == team &&
;2134:		cgs.gametype >= GT_TEAM) {
line 2135
;2135:		if (cg_drawFriend.integer) {
ADDRGP4 cg_drawFriend+12
INDIRI4
CNSTI4 0
EQI4 $968
line 2136
;2136:			CG_PlayerFloatSprite( cent, cgs.media.friendShader );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 cgs+153876+212
...
;2142:/*
;2143:===============
;2144:CG_PlayerShadow
;2145:
;2146:Returns the Z component of the surface being shadowed
;2147:
;2148:  should it return a full plane instead of a Z?
;2149:===============
;2150:*/
;2151:#define	SHADOW_DISTANCE		128
;2152:static qboolean CG_PlayerShadow( centity_t *cent, float *shadowPlane ) {
line 2153
;2153:	vec3_t		end, mins = {-15, -15, 0}, maxs = {15, 15, 2};
ADDRLP4 72
ADDRGP4 $1020
INDIRB
ASGNB 12
...
;2161:	}
;2162:
;2163:	// no shadows when invisible
;2164:	if ( cent->currentState.powerups & ( 1 << PW_INVIS ) ) {
ADDRFP4 0
INDIRP4
CNSTI4 188
ADDP4
...
;2166:	}
;2167:
;2168:	// send a trace down from the player to the ground
;2169:	VectorCopy( cent->lerpOrigin, end );
ADDRLP4 60
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2172
;2171:
;2172:	trap_CM_BoxTrace( &trace, cent->lerpOrigin, end, mins, maxs, 0, MASK_PLAYERSOLID );
ADDRLP4 0
ARGP4
ADDRFP4 0
INDIRP4
...
line 2175
;2173:
;2174:	// no shadow if too high
;2175:	if ( trace.fraction == 1.0 || trace.startsolid || trace.allsolid ) {
ADDRLP4 0+8
INDIRF4
CNSTF4 1065353216
EQF4 $1033
...
;2177:	}
;2178:
;2179:	*shadowPlane = trace.endpos[2] + 1;
ADDRFP4 4
INDIRP4
ADDRLP4 0+12+8
INDIRF4
...
line 2181
;2180:
;2181:	if ( cg_shadows.integer != 1 ) {	// no mark for stencil or projection shadows
ADDRGP4 cg_shadows+12
INDIRI4
CNSTI4 1
EQI4 $1036
...
;2183:	}
;2184:
;2185:	// fade the shadow out with height
;2186:	alpha = 1.0 - trace.fraction;
ADDRLP4 56
CNSTF4 1065353216
ADDRLP4 0+8
INDIRF4
...
line 2193
;2187:
;2188:	// bk0101022 - hack / FPE - bogus planes?
;2189:	//assert( DotProduct( trace.plane.normal, trace.plane.normal ) != 0.0f ) 
;2190:
;2191:	// add the mark as a temporary, so it goes directly to the renderer
;2192:	// without taking a spot in the cg_marks array
;2193:	CG_ImpactMark( cgs.media.shadowMarkShader, trace.endpos, trace.plane.normal, 
...
pop
line 2196
;2194:		cent->pe.legs.yawAngle, alpha,alpha,alpha,1, qfalse, 24, qtrue );
;2195:
;2196:	return qtrue;
CNSTI4 1
RETI4
...
;2200:/*
;2201:===============
;2202:CG_PlayerSplash
;2203:
;2204:Draw a mark at the water surface
;2205:===============
;2206:*/
;2207:static void CG_PlayerSplash( centity_t *cent ) {
line 2213
;2208:	vec3_t		start, end;
;2209:	trace_t		trace;
;2210:	int			contents;
;2211:	polyVert_t	verts[4];
;2212:
;2213:	if ( !cg_shadows.integer ) {
ADDRGP4 cg_shadows+12
INDIRI4
CNSTI4 0
NEI4 $1045
...
;2215:	}
;2216:
;2217:	VectorCopy( cent->lerpOrigin, end );
ADDRLP4 164
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2222
;2219:
;2220:	// if the feet aren't in liquid, don't make a mark
;2221:	// this won't handle moving water brushes, but they wouldn't draw right anyway...
;2222:	contents = trap_CM_PointContents( end, 0 );
ADDRLP4 164
ARGP4
CNSTI4 0
ARGI4
...
ASGNI4
line 2223
;2223:	if ( !( contents & ( CONTENTS_WATER | CONTENTS_SLIME | CONTENTS_LAVA ) ) ) {
ADDRLP4 176
INDIRI4
CNSTI4 56
BANDI4
...
;2225:	}
;2226:
;2227:	VectorCopy( cent->lerpOrigin, start );
ADDRLP4 152
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2231
;2229:
;2230:	// if the head isn't out of liquid, don't make a mark
;2231:	contents = trap_CM_PointContents( start, 0 );
ADDRLP4 152
ARGP4
CNSTI4 0
ARGI4
...
ASGNI4
line 2232
;2232:	if ( contents & ( CONTENTS_SOLID | CONTENTS_WATER | CONTENTS_SLIME | CONTENTS_LAVA ) ) {
ADDRLP4 176
INDIRI4
CNSTI4 57
BANDI4
...
;2234:	}
;2235:
;2236:	// trace down to find the surface
;2237:	trap_CM_BoxTrace( &trace, start, end, NULL, NULL, 0, ( CONTENTS_WATER | CONTENTS_SLIME | CONTENTS_LAVA ) );
ADDRLP4 96
ARGP4
ADDRLP4 152
ARGP4
...
;2241:	}
;2242:
;2243:	// create a mark polygon
;2244:	VectorCopy( trace.endpos, verts[0].xyz );
ADDRLP4 0
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2245
;2245:	verts[0].xyz[0] -= 32;
ADDRLP4 0
ADDRLP4 0
INDIRF4
CNSTF4 1107296256
...
ASGNF4
line 2249
;2249:	verts[0].modulate[0] = 255;
ADDRLP4 0+20
CNSTU1 255
ASGNU1
line 2250
;2250:	verts[0].modulate[1] = 255;
ADDRLP4 0+20+1
CNSTU1 255
ASGNU1
line 2251
;2251:	verts[0].modulate[2] = 255;
ADDRLP4 0+20+2
CNSTU1 255
ASGNU1
line 2252
;2252:	verts[0].modulate[3] = 255;
ADDRLP4 0+20+3
CNSTU1 255
ASGNU1
line 2254
;2253:
;2254:	VectorCopy( trace.endpos, verts[1].xyz );
ADDRLP4 0+24
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2255
;2255:	verts[1].xyz[0] -= 32;
ADDRLP4 0+24
ADDRLP4 0+24
INDIRF4
CNSTF4 1107296256
...
line 2264
;2263:
;2264:	VectorCopy( trace.endpos, verts[2].xyz );
ADDRLP4 0+48
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2265
;2265:	verts[2].xyz[0] += 32;
ADDRLP4 0+48
ADDRLP4 0+48
INDIRF4
CNSTF4 1107296256
...
ASGNF4
line 2269
;2269:	verts[2].modulate[0] = 255;
ADDRLP4 0+48+20
CNSTU1 255
ASGNU1
line 2270
;2270:	verts[2].modulate[1] = 255;
ADDRLP4 0+48+20+1
CNSTU1 255
ASGNU1
line 2271
;2271:	verts[2].modulate[2] = 255;
ADDRLP4 0+48+20+2
CNSTU1 255
ASGNU1
line 2272
;2272:	verts[2].modulate[3] = 255;
ADDRLP4 0+48+20+3
CNSTU1 255
ASGNU1
line 2274
;2273:
;2274:	VectorCopy( trace.endpos, verts[3].xyz );
ADDRLP4 0+72
ADDRLP4 96+12
INDIRB
ASGNB 12
line 2275
;2275:	verts[3].xyz[0] += 32;
ADDRLP4 0+72
ADDRLP4 0+72
INDIRF4
CNSTF4 1107296256
...
ASGNF4
line 2279
;2279:	verts[3].modulate[0] = 255;
ADDRLP4 0+72+20
CNSTU1 255
ASGNU1
line 2280
;2280:	verts[3].modulate[1] = 255;
ADDRLP4 0+72+20+1
CNSTU1 255
ASGNU1
line 2281
;2281:	verts[3].modulate[2] = 255;
ADDRLP4 0+72+20+2
CNSTU1 255
ASGNU1
line 2282
;2282:	verts[3].modulate[3] = 255;
ADDRLP4 0+72+20+3
CNSTU1 255
ASGNU1
line 2284
;2283:
;2284:	trap_R_AddPolyToScene( cgs.media.wakeMarkShader, 4, verts );
...
;2289:/*
;2290:===============
;2291:CG_AddRefEntityWithPowerups
;2292:
;2293:Adds a piece with modifications or duplications for powerups
;2294:Also called by CG_Missile for quad rockets, but nobody can tell...
;2295:===============
;2296:*/
;2297:void CG_AddRefEntityWithPowerups( refEntity_t *ent, entityState_t *state, int team ) {
line 2299
;2298:
;2299:	if ( state->powerups & ( 1 << PW_INVIS ) ) {
ADDRFP4 4
INDIRP4
CNSTI4 188
ADDP4
...
EQI4 $1135
line 2300
;2300:		ent->customShader = cgs.media.invisShader;
ADDRFP4 0
INDIRP4
CNSTI4 112
ADDP4
...
ASGNI4
line 2301
;2301:		trap_R_AddRefEntityToScene( ent );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 trap_R_AddRefEntityToScene
...
line 2312
;2303:		/*
;2304:		if ( state->eFlags & EF_KAMIKAZE ) {
;2305:			if (team == TEAM_BLUE)
;2306:				ent->customShader = cgs.media.blueKamikazeShader;
;2307:			else
;2308:				ent->customShader = cgs.media.redKamikazeShader;
...
;2313:		//}
;2314:
;2315:		if ( state->powerups & ( 1 << PW_QUAD ) )
ADDRFP4 4
INDIRP4
CNSTI4 188
ADDP4
...
line 2335
;2333:		
;2334:		//if ( state->team == TEAM_RED) {
;2335:		if (state->time2 == 9) {
ADDRFP4 4
INDIRP4
CNSTI4 88
ADDP4
...
NEI4 $1158
line 2336
;2336:			ent->customShader = cgs.media.buildShader;
ADDRFP4 0
INDIRP4
CNSTI4 112
ADDP4
...
ASGNI4
line 2337
;2337:			trap_R_AddRefEntityToScene( ent );
ADDRFP4 0
INDIRP4
ARGP4
ADDRGP4 trap_R_AddRefEntityToScene
...
line 2340
;2339:
;2340:		if ( state->powerups & ( 1 << PW_INVULNERABILITY ) ) {
ADDRFP4 4
INDIRP4
CNSTI4 188
ADDP4
...
EQI4 $1162
line 2341
;2341:			ent->customShader = cgs.media.buildShader;
ADDRFP4 0
INDIRP4
CNSTI4 112
ADDP4
...
;2350:=================
;2351:*/
;2352:int CG_LightVerts( vec3_t normal, int numVerts, polyVert_t *verts )
;2353:{
line 2360
;2354:	int				i, j;
;2355:	float			incoming;
;2356:	vec3_t			ambientLight;
;2357:	vec3_t			lightDir;
;2358:	vec3_t			directedLight;
;2359:
;2360:	trap_R_LightForPoint( verts[0].xyz, ambientLight, directedLight, lightDir );
ADDRFP4 8
INDIRP4
ARGP4
ADDRLP4 12
...
LABELV $1167
line 2363
;2363:		incoming = DotProduct (normal, lightDir);
ADDRLP4 48
ADDRFP4 0
INDIRP4
ASGNP4
...
GTF4 $1173
line 2365
;2365:			verts[i].modulate[0] = ambientLight[0];
ADDRLP4 56
ADDRLP4 12
INDIRF4
ASGNF4
...
ASGNU1
line 2366
;2366:			verts[i].modulate[1] = ambientLight[1];
ADDRLP4 68
ADDRLP4 12+4
INDIRF4
ASGNF4
...
ASGNU1
line 2367
;2367:			verts[i].modulate[2] = ambientLight[2];
ADDRLP4 80
ADDRLP4 12+8
INDIRF4
ASGNF4
...
line 2371
;2370:		} 
;2371:		j = ( ambientLight[0] + incoming * directedLight[0] );
ADDRLP4 0
ADDRLP4 12
INDIRF4
ADDRLP4 8
...
line 2377
;2376:
;2377:		j = ( ambientLight[1] + incoming * directedLight[1] );
ADDRLP4 0
ADDRLP4 12+4
INDIRF4
ADDRLP4 8
...
line 2383
;2382:
;2383:		j = ( ambientLight[2] + incoming * directedLight[2] );
ADDRLP4 0
ADDRLP4 12+8
INDIRF4
ADDRLP4 8
...
;2397:===============
;2398:*/
;2399:void CG_Player( centity_t *cent ) {
line 2420
;2400:	clientInfo_t	*ci;
;2401:	refEntity_t		legs;
;2402:	refEntity_t		torso;
;2403:	refEntity_t		head;
;2404:	int				clientNum;
;2405:	int				renderfx;
;2406:	qboolean		shadow;
;2407:	float			shadowPlane;
;2408:#ifdef MISSIONPACK
;2409:	refEntity_t		skull;
;2410:	refEntity_t		powerup;
;2411:	int				t;
;2412:	float			c;
;2413:	float			angle;
;2414:	vec3_t			dir, angles;
;2415:#endif
;2416:
;2417:	// the client number is stored in clientNum.  It can't be derived
;2418:	// from the entity number, because a single client may have
;2419:	// multiple corpses on the level using the same clientinfo
;2420:	clientNum = cent->currentState.clientNum;
ADDRLP4 428
ADDRFP4 0
INDIRP4
CNSTI4 168
...
ASGNI4
line 2421
;2421:	if ( clientNum < 0 || clientNum >= MAX_CLIENTS ) {
ADDRLP4 428
INDIRI4
CNSTI4 0
LTI4 $1199
...
LABELV $1199
line 2422
;2422:		CG_Error( "Bad clientNum on player entity");
ADDRGP4 $1200
ARGP4
ADDRGP4 CG_Error
CALLV
...
LABELV $1197
line 2424
;2424:	ci = &cgs.clientinfo[ clientNum ];
ADDRLP4 280
CNSTI4 1732
ADDRLP4 428
INDIRI4
...
line 2428
;2425:
;2426:	// it is possible to see corpses from disconnected players that may
;2427:	// not have valid clientinfo
;2428:	if ( !ci->infoValid ) {
ADDRLP4 280
INDIRP4
INDIRI4
CNSTI4 0
...
;2430:	}
;2431:
;2432:	// get the player model information
;2433:	renderfx = 0;
ADDRLP4 424
CNSTI4 0
ASGNI4
line 2434
;2434:	if ( cent->currentState.number == cg.snap->ps.clientNum) {
ADDRFP4 0
INDIRP4
INDIRI4
ADDRGP4 cg+36
...
NEI4 $1204
line 2435
;2435:		if (!cg.renderingThirdPerson) {
ADDRGP4 cg+109676
INDIRI4
CNSTI4 0
NEI4 $1207
line 2436
;2436:			renderfx = RF_THIRD_PERSON;			// only draw in mirrors
ADDRLP4 424
CNSTI4 2
ASGNI4
line 2437
...
;2443:
;2444:
;2445:	memset( &legs, 0, sizeof(legs) );
ADDRLP4 0
ARGP4
CNSTI4 0
ARGI4
...
pop
line 2446
;2446:	memset( &torso, 0, sizeof(torso) );
ADDRLP4 140
ARGP4
CNSTI4 0
ARGI4
...
line 2450
;2448:
;2449:	// get the rotation information
;2450:	CG_PlayerAngles( cent, legs.axis, torso.axis, head.axis );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 0+28
...
line 2453
;2451:	
;2452:	// get the animation state (after rotation, to allow feet shuffle)
;2453:	CG_PlayerAnimation( cent, &legs.oldframe, &legs.frame, &legs.backlerp,
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 0+96
...
pop
line 2457
;2454:		 &torso.oldframe, &torso.frame, &torso.backlerp );
;2455:
;2456:	// add the talk baloon or disconnect icon
;2457:	CG_PlayerSprites( cent );
ADDRFP4 0
INDIRP4
ARGP4
...
;2458:
;2459:	// add the shadow
;2460:	shadow = CG_PlayerShadow( cent, &shadowPlane );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 432
...
line 2463
;2461:
;2462:	// add a water splash if partially in and out of water
;2463:	CG_PlayerSplash( cent );
ADDRFP4 0
INDIRP4
ARGP4
...
LABELV $1222
line 2468
;2468:	renderfx |= RF_LIGHTING_ORIGIN;			// use the same origin for all
ADDRLP4 424
ADDRLP4 424
INDIRI4
CNSTI4 128
...
ASGNI4
line 2477
;2469:#ifdef MISSIONPACK
;2470:	if( cgs.gametype == GT_HARVESTER ) {
;2471:		CG_PlayerTokens( cent, renderfx );
;2472:	}
;2473:#endif
;2474:	//
;2475:	// add the legs
;2476:	//
;2477:	legs.hModel = ci->legsModel;
ADDRLP4 0+8
ADDRLP4 280
INDIRP4
CNSTI4 520
...
ASGNI4
line 2478
;2478:	legs.customSkin = ci->legsSkin;
ADDRLP4 0+108
ADDRLP4 280
INDIRP4
CNSTI4 524
...
line 2480
;2479:
;2480:	VectorCopy( cent->lerpOrigin, legs.origin );
ADDRLP4 0+68
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2482
;2481:
;2482:	VectorCopy( cent->lerpOrigin, legs.lightingOrigin );
ADDRLP4 0+12
ADDRFP4 0
INDIRP4
CNSTI4 716
...
ASGNB 12
line 2483
;2483:	legs.shadowPlane = shadowPlane;
ADDRLP4 0+24
ADDRLP4 432
INDIRF4
ASGNF4
line 2484
;2484:	legs.renderfx = renderfx;
ADDRLP4 0+4
ADDRLP4 424
INDIRI4
ASGNI4
line 2485
;2485:	VectorCopy (legs.origin, legs.oldorigin);	// don't positionally lerp at all
ADDRLP4 0+84
ADDRLP4 0+68
INDIRB
ASGNB 12
line 2487
;2486:
;2487:	CG_AddRefEntityWithPowerups( &legs, &cent->currentState, ci->team );
ADDRLP4 0
ARGP4
ADDRFP4 0
INDIRP4
...
line 2490
;2488:
;2489:	// if the model failed, allow the default nullmodel to be displayed
;2490:	if (!legs.hModel) {
ADDRLP4 0+8
INDIRI4
CNSTI4 0
...
;2495:	// add the torso
;2496:	//
;2497:	torso.hModel = ci->torsoModel;
ADDRLP4 140+8
ADDRLP4 280
INDIRP4
CNSTI4 528
...
;2500:	}
;2501:
;2502:	torso.customSkin = ci->torsoSkin;
ADDRLP4 140+108
ADDRLP4 280
INDIRP4
CNSTI4 532
...
line 2504
;2503:
;2504:	VectorCopy( cent->lerpOrigin, torso.lightingOrigin );
ADDRLP4 140+12
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2506
;2505:
;2506:	CG_PositionRotatedEntityOnTag( &torso, &legs, ci->legsModel, "tag_torso");
ADDRLP4 140
ARGP4
ADDRLP4 0
ARGP4
...
line 2508
;2507:
;2508:	torso.shadowPlane = shadowPlane;
ADDRLP4 140+24
ADDRLP4 432
INDIRF4
ASGNF4
line 2509
;2509:	torso.renderfx = renderfx;
ADDRLP4 140+4
ADDRLP4 424
INDIRI4
ASGNI4
line 2511
;2510:
;2511:	CG_AddRefEntityWithPowerups( &torso, &cent->currentState, ci->team );
ADDRLP4 140
ARGP4
ADDRFP4 0
INDIRP4
...
;2514:	if ( cent->currentState.eFlags & EF_KAMIKAZE ) {
;2515:
;2516:		memset( &skull, 0, sizeof(skull) );
;2517:
;2518:		VectorCopy( cent->lerpOrigin, skull.lightingOrigin );
;2519:		skull.shadowPlane = shadowPlane;
;2520:		skull.renderfx = renderfx;
;2521:
;2522:		if ( cent->currentState.eFlags & EF_DEAD ) {
;2523:			// one skull bobbing above the dead body
;2524:			angle = ((cg.time / 7) & 255) * (M_PI * 2) / 255;
;2525:			if (angle > M_PI * 2)
;2526:				angle -= (float)M_PI * 2;
;2527:			dir[0] = sin(angle) * 20;
;2528:			dir[1] = cos(angle) * 20;
;2529:			angle = ((cg.time / 4) & 255) * (M_PI * 2) / 255;
;2530:			dir[2] = 15 + sin(angle) * 8;
;2531:			VectorAdd(torso.origin, dir, skull.origin);
;2532:			
;2533:			dir[2] = 0;
;2534:			VectorCopy(dir, skull.axis[1]);
;2535:			VectorNormalize(skull.axis[1]);
;2536:			VectorSet(skull.axis[2], 0, 0, 1);
;2537:			CrossProduct(skull.axis[1], skull.axis[2], skull.axis[0]);
;2538:
;2539:			skull.hModel = cgs.media.kamikazeHeadModel;
;2540:			trap_R_AddRefEntityToScene( &skull );
;2541:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2542:			trap_R_AddRefEntityToScene( &skull );
;2543:		}
;2544:		else {
;2545:			// three skulls spinning around the player
;2546:			angle = ((cg.time / 4) & 255) * (M_PI * 2) / 255;
;2547:			dir[0] = cos(angle) * 20;
;2548:			dir[1] = sin(angle) * 20;
;2549:			dir[2] = cos(angle) * 20;
;2550:			VectorAdd(torso.origin, dir, skull.origin);
;2551:
;2552:			angles[0] = sin(angle) * 30;
;2553:			angles[1] = (angle * 180 / M_PI) + 90;
;2554:			if (angles[1] > 360)
;2555:				angles[1] -= 360;
;2556:			angles[2] = 0;
;2557:			AnglesToAxis( angles, skull.axis );
;2558:
;2559:			/*
;2560:			dir[2] = 0;
;2561:			VectorInverse(dir);
;2562:			VectorCopy(dir, skull.axis[1]);
;2563:			VectorNormalize(skull.axis[1]);
;2564:			VectorSet(skull.axis[2], 0, 0, 1);
;2565:			CrossProduct(skull.axis[1], skull.axis[2], skull.axis[0]);
;2566:			*/
;2567:
;2568:			skull.hModel = cgs.media.kamikazeHeadModel;
;2569:			trap_R_AddRefEntityToScene( &skull );
;2570:			// flip the trail because this skull is spinning in the other direction
;2571:			VectorInverse(skull.axis[1]);
;2572:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2573:			trap_R_AddRefEntityToScene( &skull );
;2574:
;2575:			angle = ((cg.time / 4) & 255) * (M_PI * 2) / 255 + M_PI;
;2576:			if (angle > M_PI * 2)
;2577:				angle -= (float)M_PI * 2;
;2578:			dir[0] = sin(angle) * 20;
;2579:			dir[1] = cos(angle) * 20;
;2580:			dir[2] = cos(angle) * 20;
;2581:			VectorAdd(torso.origin, dir, skull.origin);
;2582:
;2583:			angles[0] = cos(angle - 0.5 * M_PI) * 30;
;2584:			angles[1] = 360 - (angle * 180 / M_PI);
;2585:			if (angles[1] > 360)
;2586:				angles[1] -= 360;
;2587:			angles[2] = 0;
;2588:			AnglesToAxis( angles, skull.axis );
;2589:
;2590:			/*
;2591:			dir[2] = 0;
...
;2596:			*/
;2597:
;2598:			skull.hModel = cgs.media.kamikazeHeadModel;
;2599:			trap_R_AddRefEntityToScene( &skull );
;2600:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2601:			trap_R_AddRefEntityToScene( &skull );
;2602:
;2603:			angle = ((cg.time / 3) & 255) * (M_PI * 2) / 255 + 0.5 * M_PI;
;2604:			if (angle > M_PI * 2)
;2605:				angle -= (float)M_PI * 2;
;2606:			dir[0] = sin(angle) * 20;
;2607:			dir[1] = cos(angle) * 20;
;2608:			dir[2] = 0;
;2609:			VectorAdd(torso.origin, dir, skull.origin);
;2610:			
;2611:			VectorCopy(dir, skull.axis[1]);
;2612:			VectorNormalize(skull.axis[1]);
;2613:			VectorSet(skull.axis[2], 0, 0, 1);
;2614:			CrossProduct(skull.axis[1], skull.axis[2], skull.axis[0]);
;2615:
;2616:			skull.hModel = cgs.media.kamikazeHeadModel;
;2617:			trap_R_AddRefEntityToScene( &skull );
;2618:			skull.hModel = cgs.media.kamikazeHeadTrail;
;2619:			trap_R_AddRefEntityToScene( &skull );
;2620:		}
;2621:	}
;2622:
;2623:	if ( cent->currentState.powerups & ( 1 << PW_GUARD ) ) {
;2624:		memcpy(&powerup, &torso, sizeof(torso));
;2625:		powerup.hModel = cgs.media.guardPowerupModel;
;2626:		powerup.frame = 0;
;2627:		powerup.oldframe = 0;
;2628:		powerup.customSkin = 0;
;2629:		trap_R_AddRefEntityToScene( &powerup );
;2630:	}
;2631:	if ( cent->currentState.powerups & ( 1 << PW_SCOUT ) ) {
;2632:		memcpy(&powerup, &torso, sizeof(torso));
;2633:		powerup.hModel = cgs.media.scoutPowerupModel;
;2634:		powerup.frame = 0;
;2635:		powerup.oldframe = 0;
;2636:		powerup.customSkin = 0;
;2637:		trap_R_AddRefEntityToScene( &powerup );
;2638:	}
;2639:	if ( cent->currentState.powerups & ( 1 << PW_DOUBLER ) ) {
;2640:		memcpy(&powerup, &torso, sizeof(torso));
;2641:		powerup.hModel = cgs.media.doublerPowerupModel;
;2642:		powerup.frame = 0;
;2643:		powerup.oldframe = 0;
;2644:		powerup.customSkin = 0;
;2645:		trap_R_AddRefEntityToScene( &powerup );
;2646:	}
;2647:	if ( cent->currentState.powerups & ( 1 << PW_AMMOREGEN ) ) {
;2648:		memcpy(&powerup, &torso, sizeof(torso));
;2649:		powerup.hModel = cgs.media.ammoRegenPowerupModel;
;2650:		powerup.frame = 0;
;2651:		powerup.oldframe = 0;
;2652:		powerup.customSkin = 0;
;2653:		trap_R_AddRefEntityToScene( &powerup );
;2654:	}
;2655:	if ( cent->currentState.powerups & ( 1 << PW_INVULNERABILITY ) ) {
;2656:		if ( !ci->invulnerabilityStartTime ) {
;2657:			ci->invulnerabilityStartTime = cg.time;
;2658:		}
;2659:		ci->invulnerabilityStopTime = cg.time;
;2660:	}
;2661:	else {
;2662:		ci->invulnerabilityStartTime = 0;
;2663:	}
;2664:	if ( (cent->currentState.powerups & ( 1 << PW_INVULNERABILITY ) ) ||
;2665:		cg.time - ci->invulnerabilityStopTime < 250 ) {
;2666:
;2667:		memcpy(&powerup, &torso, sizeof(torso));
;2668:		powerup.hModel = cgs.media.invulnerabilityPowerupModel;
;2669:		powerup.customSkin = 0;
;2670:		// always draw
;2671:		powerup.renderfx &= ~RF_THIRD_PERSON;
;2672:		VectorCopy(cent->lerpOrigin, powerup.origin);
;2673:
;2674:		if ( cg.time - ci->invulnerabilityStartTime < 250 ) {
;2675:			c = (float) (cg.time - ci->invulnerabilityStartTime) / 250;
;2676:		}
;2677:		else if (cg.time - ci->invulnerabilityStopTime < 250 ) {
;2678:			c = (float) (250 - (cg.time - ci->invulnerabilityStopTime)) / 250;
;2679:		}
;2680:		else {
;2681:			c = 1;
;2682:		}
;2683:		VectorSet( powerup.axis[0], c, 0, 0 );
;2684:		VectorSet( powerup.axis[1], 0, c, 0 );
;2685:		VectorSet( powerup.axis[2], 0, 0, c );
;2686:		trap_R_AddRefEntityToScene( &powerup );
;2687:	}
;2688:
;2689:	t = cg.time - ci->medkitUsageTime;
;2690:	if ( ci->medkitUsageTime && t < 500 ) {
;2691:		memcpy(&powerup, &torso, sizeof(torso));
;2692:		powerup.hModel = cgs.media.medkitUsageModel;
;2693:		powerup.customSkin = 0;
;2694:		// always draw
;2695:		powerup.renderfx &= ~RF_THIRD_PERSON;
;2696:		VectorClear(angles);
;2697:		AnglesToAxis(angles, powerup.axis);
;2698:		VectorCopy(cent->lerpOrigin, powerup.origin);
;2699:		powerup.origin[2] += -24 + (float) t * 80 / 500;
;2700:		if ( t > 400 ) {
;2701:			c = (float) (t - 1000) * 0xff / 100;
;2702:			powerup.shaderRGBA[0] = 0xff - c;
;2703:			powerup.shaderRGBA[1] = 0xff - c;
;2704:			powerup.shaderRGBA[2] = 0xff - c;
;2705:			powerup.shaderRGBA[3] = 0xff - c;
;2706:		}
;2707:		else {
;2708:			powerup.shaderRGBA[0] = 0xff;
;2709:			powerup.shaderRGBA[1] = 0xff;
;2710:			powerup.shaderRGBA[2] = 0xff;
;2711:			powerup.shaderRGBA[3] = 0xff;
;2712:		}
;2713:		trap_R_AddRefEntityToScene( &powerup );
;2714:	}
;2715:#endif // MISSIONPACK
;2716:
;2717:	//
;2718:	// add the head
;2719:	//
;2720:	// Shafe - Trep - This is all new code for headshots
;2721:	if(!cent->pe.noHead)
ADDRFP4 0
INDIRP4
CNSTI4 644
ADDP4
...
line 2730
;2729:
;2730:		VectorCopy( cent->lerpOrigin, head.lightingOrigin );
ADDRLP4 284+12
ADDRFP4 0
INDIRP4
CNSTI4 716
...
line 2732
;2731:
;2732:		CG_PositionRotatedEntityOnTag( &head, &torso, ci->torsoModel, "tag_head");
ADDRLP4 284
ARGP4
ADDRLP4 140
ARGP4
...
line 2734
;2733:
;2734:		head.shadowPlane = shadowPlane;
ADDRLP4 284+24
ADDRLP4 432
INDIRF4
ASGNF4
line 2735
;2735:		head.renderfx = renderfx;
ADDRLP4 284+4
ADDRLP4 424
INDIRI4
ASGNI4
line 2737
;2736:
;2737:		CG_AddRefEntityWithPowerups( &head, &cent->currentState, ci->team );
ADDRLP4 284
ARGP4
ADDRFP4 0
INDIRP4
...
line 2767
;2739:
;2740:	/*  Shafe - Trep - This is the original code -- Fuck.. Lets hope we dont end up compiling with MISSIONPACK!
;2741:	head.hModel = ci->headModel;
;2742:	if (!head.hModel) {
;2743:		return;
;2744:	}
;2745:	head.customSkin = ci->headSkin;
;2746:
;2747:	VectorCopy( cent->lerpOrigin, head.lightingOrigin );
;2748:
;2749:	CG_PositionRotatedEntityOnTag( &head, &torso, ci->torsoModel, "tag_head");
;2750:
;2751:	head.shadowPlane = shadowPlane;
;2752:	head.renderfx = renderfx;
;2753:
;2754:	CG_AddRefEntityWithPowerups( &head, &cent->currentState, ci->team );
;2755:	*/
;2756:
;2757:
;2758:#ifdef MISSIONPACK
;2759:	CG_BreathPuffs(cent, &head);
;2760:
;2761:	CG_DustTrail(cent);
;2762:#endif
;2763:
;2764:	//
;2765:	// add the gun / barrel / flash
;2766:	//
;2767:	CG_AddPlayerWeapon( &torso, NULL, cent, ci->team );
ADDRLP4 140
ARGP4
CNSTP4 0
ARGP4
...
line 2770
;2768:
;2769:	// add powerups floating behind the player
;2770:	CG_PlayerPowerups( cent, &torso );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 140
...
line 2774
;2771:
;2772://unlagged - client options
;2773:	// add the bounding box (if cg_drawBBox is 1)
;2774:	CG_AddBoundingBox( cent );
ADDRFP4 0
INDIRP4
ARGP4
...
;2781:/*
;2782:===============
;2783:CG_ResetPlayerEntity
;2784:
;2785:A player just came into view or teleported, so reset all animation info
;2786:===============
;2787:*/
;2788:void CG_ResetPlayerEntity( centity_t *cent ) {
line 2789
;2789:	cent->errorTime = -99999;		// guarantee no error decay added
ADDRFP4 0
INDIRP4
CNSTI4 648
ADDP4
...
line 2792
;2791:
;2792:	CG_ClearLerpFrame( &cgs.clientinfo[ cent->currentState.clientNum ], &cent->pe.legs, cent->currentState.legsAnim );
ADDRLP4 0
ADDRFP4 0
INDIRP4
ASGNP4
...
pop
line 2793
;2793:	CG_ClearLerpFrame( &cgs.clientinfo[ cent->currentState.clientNum ], &cent->pe.torso, cent->currentState.torsoAnim );
ADDRLP4 4
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2795
;2794:
;2795:	BG_EvaluateTrajectory( &cent->currentState.pos, cg.time, cent->lerpOrigin );
ADDRLP4 8
ADDRFP4 0
INDIRP4
ASGNP4
...
pop
line 2796
;2796:	BG_EvaluateTrajectory( &cent->currentState.apos, cg.time, cent->lerpAngles );
ADDRLP4 12
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2798
;2797:
;2798:	VectorCopy( cent->lerpOrigin, cent->rawOrigin );
ADDRLP4 16
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNB 12
line 2799
;2799:	VectorCopy( cent->lerpAngles, cent->rawAngles );
ADDRLP4 20
ADDRFP4 0
INDIRP4
ASGNP4
...
line 2801
;2800:
;2801:	memset( &cent->pe.legs, 0, sizeof( cent->pe.legs ) );
ADDRFP4 0
INDIRP4
CNSTI4 460
ADDP4
...
pop
line 2802
;2802:	cent->pe.legs.yawAngle = cent->rawAngles[YAW];
ADDRLP4 24
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2803
;2803:	cent->pe.legs.yawing = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 484
ADDP4
...
ASGNI4
line 2804
;2804:	cent->pe.legs.pitchAngle = 0;
ADDRFP4 0
INDIRP4
CNSTI4 488
ADDP4
...
ASGNF4
line 2805
;2805:	cent->pe.legs.pitching = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 492
ADDP4
...
line 2807
;2806:
;2807:	memset( &cent->pe.torso, 0, sizeof( cent->pe.legs ) );
ADDRFP4 0
INDIRP4
CNSTI4 508
ADDP4
...
pop
line 2808
;2808:	cent->pe.torso.yawAngle = cent->rawAngles[YAW];
ADDRLP4 28
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2809
;2809:	cent->pe.torso.yawing = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 532
ADDP4
...
ASGNI4
line 2810
;2810:	cent->pe.torso.pitchAngle = cent->rawAngles[PITCH];
ADDRLP4 32
ADDRFP4 0
INDIRP4
ASGNP4
...
ASGNF4
line 2811
;2811:	cent->pe.torso.pitching = qfalse;
ADDRFP4 0
INDIRP4
CNSTI4 540
ADDP4
...
line 2813
;2812:
;2813:	cent->pe.noHead = qfalse; // Shafe - Trep - Part of the headshot code
ADDRFP4 0
INDIRP4
CNSTI4 644
ADDP4
...
line 2815
;2814:
;2815:	if ( cg_debugPosition.integer ) {
ADDRGP4 cg_debugPosition+12
INDIRI4
CNSTI4 0
EQI4 $1261
line 2816
;2816:		CG_Printf("%i ResetPlayerEntity yaw=%i\n", cent->currentState.number, cent->pe.torso.yawAngle );
ADDRGP4 $1264
ARGP4
ADDRLP4 36
ADDRFP4 0
