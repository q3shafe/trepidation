...
pop
line 206
;206:		UI_DrawString( 320, 400, "Tredpidation(c)2006, GPLed by The Trepidation Project", UI_CENTER|UI_SMALLFONT, color );
CNSTI4 320
ARGI4
CNSTI4 400
ARGI4
...
pop
line 273
;273:	if (strlen(s_errorMessage.errorMessage))
ADDRGP4 s_errorMessage+288
ARGP4
ADDRLP4 16
ADDRGP4 strlen
...
ASGNI4
line 279
;279:		s_errorMessage.menu.showlogo = qfalse;	// Shafe - Trep - Temporarily qfalse
...
ASGNI4
line 291
;291:	s_main.menu.showlogo = qfalse; // Shafe - Trep - Temporarily qfalse
ADDRGP4 s_main+284
CNSTI4 0
ASGNI4
line 293
