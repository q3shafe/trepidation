...
static void Main_MenuDraw( void ) {
	...
	if (uis.demoversion) {
		...
		UI_DrawString( 320, 400, "Tredpidation (c)2006-2019, N5 Networks / Team Trepidation", UI_CENTER|UI_SMALLFONT, color );
	} else {
		UI_DrawString( 320, 450, "Tredpidation (c)2006-2019, N5 Networks / Team Trepidation", UI_CENTER|UI_SMALLFONT, color );
	}
}
