...
;1886:  ListPlayers
;1887:
;1888:  Please clean this up
;1889:======================================
;1890:*/
;1891:void Cmd_ListPlayers_f ( gentity_t *ent ) {
line 1904
;1892:
;1893:int		i;
;1894:int		j;
...
;1898:int		ping;
;1899:int		score;
;1900:char	userinfo[MAX_INFO_STRING];
;1901:char	*value;
;1902:char		n2[MAX_STRING_CHARS];
;1903:		
;1904:		trap_SendServerCommand( ent-g_entities, va("print \"CLIENT LIST\""));
ADDRGP4 $1000
ARGP4
ADDRLP4 2080
ADDRGP4 va
...
pop
line 1905
;1905:		trap_SendServerCommand( ent-g_entities, va("print \"Client  -  Name                   - Ping   -  Score - GUID\""));
ADDRGP4 $1001
ARGP4
ADDRLP4 2084
ADDRGP4 va
...
pop
line 1906
;1906:		trap_SendServerCommand( ent-g_entities, va("print \"---------------------------------------------------------------------------------------\""));
ADDRGP4 $1002
ARGP4
ADDRLP4 2088
ADDRGP4 va
...
line 1908
;1907:
;1908:		for ( i = 0 ; i < level.maxclients ; i++ ) {
ADDRLP4 8
CNSTI4 0
ASGNI4
ADDRGP4 $1006
...
line 1910
;1909:	
;1910:			if ( level.clients[i].pers.connected == CON_DISCONNECTED ) {
CNSTI4 3452
ADDRLP4 8
INDIRI4
MULI4
...
;1912:			}
;1913:				
;1914:			clientNum = level.clients[i].ps.clientNum;
ADDRLP4 12
CNSTI4 3452
ADDRLP4 8
INDIRI4
...
line 1916
;1915:			
;1916:			ping = level.clients[i].ps.ping;
ADDRLP4 2068
CNSTI4 3452
ADDRLP4 8
INDIRI4
...
ASGNI4
line 1917
;1917:			score = level.clients[i].ps.persistant[PERS_SCORE];
ADDRLP4 2072
CNSTI4 3452
ADDRLP4 8
INDIRI4
...
line 1919
;1918:			
;1919:			trap_SendServerCommand( ent-g_entities, va("print \"%i  - %s\"", clientNum, level.clients[i].pers.netname ));
ADDRGP4 $1010
ARGP4
ADDRLP4 12
INDIRI4
...
line 1921
;1920:			
;1921:			SanitizeString( level.clients[i].pers.netname, n2 );
CNSTI4 3452
ADDRLP4 8
INDIRI4
MULI4
...
LTI4 $1011
line 1928
;1928:			trap_GetUserinfo( clientNum, userinfo, sizeof( userinfo ) );
ADDRLP4 12
INDIRI4
ARGI4
ADDRLP4 16
...
pop
line 1929
;1929:			value = Info_ValueForKey (userinfo, "cl_guid");
ADDRLP4 16
ARGP4
ADDRGP4 $1015
ARGP4
...
ASGNP4
line 1930
;1930:			trap_SendServerCommand( ent-g_entities, va("print \"  -  %i  -  %i  -  %s\n\"", ping, score, value ));
ADDRGP4 $1016
ARGP4
ADDRLP4 2068
INDIRI4
...
;1939:==================
;1940:*/
;1941:void Cmd_TeamVote_f( gentity_t *ent ) {
line 1945
;1942:	int			team, cs_offset;
;1943:	char		msg[64];
;1944:
;1945:	team = ent->client->sess.sessionTeam;
ADDRLP4 68
ADDRFP4 0
INDIRP4
CNSTI4 524
...
line 1953
;1952:
;1953:	if ( !level.teamVoteTime[cs_offset] ) {
ADDRLP4 64
INDIRI4
CNSTI4 2
LSHI4
...
NEI4 $1022
line 1954
;1954:		trap_SendServerCommand( ent-g_entities, "print \"No team vote in progress.\n\"" );
ADDRFP4 0
INDIRP4
CVPU4 4
ADDRGP4 g_entities
...
line 1957
;1956:	}
;1957:	if ( ent->client->ps.eFlags & EF_TEAMVOTED ) {
ADDRFP4 0
INDIRP4
CNSTI4 524
ADDP4
...
EQI4 $1026
line 1958
;1958:		trap_SendServerCommand( ent-g_entities, "print \"Team vote already cast.\n\"" );
ADDRFP4 0
INDIRP4
CVPU4 4
ADDRGP4 g_entities
...
line 1961
;1960:	}
;1961:	if ( ent->client->sess.sessionTeam == TEAM_SPECTATOR ) {
ADDRFP4 0
INDIRP4
CNSTI4 524
ADDP4
...
NEI4 $1029
line 1962
;1962:		trap_SendServerCommand( ent-g_entities, "print \"Not allowed to vote as spectator.\n\"" );
ADDRFP4 0
INDIRP4
CVPU4 4
ADDRGP4 g_entities
...
;1964:	}
;1965:
;1966:	trap_SendServerCommand( ent-g_entities, "print \"Team vote cast.\n\"" );
ADDRFP4 0
INDIRP4
CVPU4 4
ADDRGP4 g_entities
...
line 1968
;1967:
;1968:	ent->client->ps.eFlags |= EF_TEAMVOTED;
ADDRLP4 72
ADDRFP4 0
INDIRP4
CNSTI4 524
...
line 1970
;1969:
;1970:	trap_Argv( 1, msg, sizeof( msg ) );
CNSTI4 1
ARGI4
ADDRLP4 0
ARGP4
...
line 1972
;1971:
;1972:	if ( msg[0] == 'y' || msg[1] == 'Y' || msg[1] == '1' ) {
ADDRLP4 0
INDIRI1
CVII4 1
CNSTI4 121
...
LABELV $1037
line 1973
;1973:		level.teamVoteYes[cs_offset]++;
ADDRLP4 76
ADDRLP4 64
INDIRI4
CNSTI4 2
...
ASGNI4
line 1974
;1974:		trap_SetConfigstring( CS_TEAMVOTE_YES + cs_offset, va("%i", level.teamVoteYes[cs_offset] ) );
ADDRGP4 $879
ARGP4
ADDRLP4 64
INDIRI4
...
LABELV $1032
line 1976
;1976:		level.teamVoteNo[cs_offset]++;
ADDRLP4 76
ADDRLP4 64
INDIRI4
CNSTI4 2
...
ASGNI4
line 1977
;1977:		trap_SetConfigstring( CS_TEAMVOTE_NO + cs_offset, va("%i", level.teamVoteNo[cs_offset] ) );	
ADDRGP4 $879
ARGP4
ADDRLP4 64
INDIRI4
...
line 1982
;1979:
;1980:	// a majority will be determined in TeamCheckVote, which will also account
;1981:	// for players entering or leaving
;1982:}
LABELV $1017
...
;1985:/*
;1986:=================
;1987:Cmd_SetViewpos_f
;1988:=================
;1989:*/
;1990:void Cmd_SetViewpos_f( gentity_t *ent ) {
line 1995
;1991:	vec3_t		origin, angles;
;1992:	char		buffer[MAX_TOKEN_CHARS];
;1993:	int			i;
;1994:
;1995:	if ( !g_cheats.integer ) {
ADDRGP4 g_cheats+12
INDIRI4
CNSTI4 0
NEI4 $1043
line 1996
;1996:		trap_SendServerCommand( ent-g_entities, va("print \"Cheats are not enabled on this server.\n\""));
ADDRGP4 $252
ARGP4
ADDRLP4 1052
ADDRGP4 va
...
EQI4 $1046
line 2000
;2000:		trap_SendServerCommand( ent-g_entities, va("print \"usage: setviewpos x y z yaw\n\""));
ADDRGP4 $1048
ARGP4
ADDRLP4 1056
ADDRGP4 va
...
LABELV $1051
line 2006
;2006:		trap_Argv( i + 1, buffer, sizeof( buffer ) );
ADDRLP4 0
INDIRI4
CNSTI4 1
ADDI4
...
line 2010
;2009:
;2010:	trap_Argv( 4, buffer, sizeof( buffer ) );
CNSTI4 4
ARGI4
ADDRLP4 4
ARGP4
...
line 2013
;2012:
;2013:	TeleportPlayer( ent, origin, angles );
ADDRFP4 0
INDIRP4
ARGP4
ADDRLP4 1028
...
;2021:=================
;2022:*/
;2023:void Cmd_Stats_f( gentity_t *ent ) {
line 2038
;2024:/*
;2025:	int max, n, i;
;2026:
;2027:	max = trap_AAS_PointReachabilityAreaIndex( NULL );
;2028:
;2029:	n = 0;
;2030:	for ( i = 0; i < max; i++ ) {
;2031:		if ( ent->client->areabits[i >> 3] & (1 << (i & 7)) )
;2032:			n++;
;2033:	}
;2034:
;2035:	//trap_SendServerCommand( ent-g_entities, va("print \"visited %d of %d areas\n\"", n, max));
;2036:	trap_SendServerCommand( ent-g_entities, va("print \"%d%% level coverage\n\"", n * 100 / max));
;2037:*/
;2038:}
LABELV $1056
...
;2043:=================
;2044:*/
;2045:void ClientCommand( int clientNum ) {
line 2049
;2046:	gentity_t *ent;
;2047:	char	cmd[MAX_TOKEN_CHARS];
;2048:
;2049:	ent = g_entities + clientNum;
ADDRLP4 1024
CNSTI4 916
ADDRFP4 0
INDIRI4
...
NEU4 $1058
line 2051
;2051:		return;		// not fully in game yet
ADDRGP4 $1057
JUMPV
LABELV $1058
line 2055
...
;2053:
;2054:
;2055:	trap_Argv( 0, cmd, sizeof( cmd ) );
CNSTI4 0
ARGI4
ADDRLP4 0
ARGP4
...
NEI4 $1060
line 2058
;2058:		Cmd_Say_f (ent, SAY_ALL, qfalse);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRLP4 1032
...
line 2061
;2060:	}
;2061:	if (Q_stricmp (cmd, "say_team") == 0) {
ADDRLP4 0
ARGP4
ADDRGP4 $1065
ARGP4
...
NEI4 $1063
line 2062
;2062:		Cmd_Say_f (ent, SAY_TEAM, qfalse);
ADDRLP4 1024
INDIRP4
ARGP4
CNSTI4 1
...
NEI4 $1069
line 2070
;2070:		Cmd_Voice_f (ent, SAY_ALL, qfalse, qfalse);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRLP4 1044
...
line 2073
;2072:	}
;2073:	if (Q_stricmp (cmd, "vsay_team") == 0) {
ADDRLP4 0
ARGP4
ADDRGP4 $1074
ARGP4
...
NEI4 $1072
line 2074
;2074:		Cmd_Voice_f (ent, SAY_TEAM, qfalse, qfalse);
ADDRLP4 1024
INDIRP4
ARGP4
CNSTI4 1
...
NEI4 $1075
line 2078
;2078:		Cmd_VoiceTell_f ( ent, qfalse );
ADDRLP4 1024
INDIRP4
ARGP4
CNSTI4 0
...
NEI4 $1077
line 2082
;2082:		Cmd_Voice_f (ent, SAY_ALL, qfalse, qtrue);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRLP4 1056
...
line 2085
;2084:	}
;2085:	if (Q_stricmp (cmd, "vosay_team") == 0) {
ADDRLP4 0
ARGP4
ADDRGP4 $1082
ARGP4
...
NEI4 $1080
line 2086
;2086:		Cmd_Voice_f (ent, SAY_TEAM, qfalse, qtrue);
ADDRLP4 1024
INDIRP4
ARGP4
ADDRLP4 1060
...
line 2089
;2088:	}
;2089:	if (Q_stricmp (cmd, "votell") == 0) {
ADDRLP4 0
ARGP4
ADDRGP4 $1085
ARGP4
...
NEI4 $1083
line 2090
;2090:		Cmd_VoiceTell_f ( ent, qtrue );
ADDRLP4 1024
INDIRP4
ARGP4
CNSTI4 1
...
line 2093
;2092:	}
;2093:	if (Q_stricmp (cmd, "vtaunt") == 0) {
ADDRLP4 0
ARGP4
ADDRGP4 $1088
ARGP4
...
;2100:	}
;2101:
;2102:	// ignore all other commands when at intermission
;2103:	if (level.intermissiontime) {
ADDRGP4 level+9140
INDIRI4
CNSTI4 0
EQI4 $1091
line 2104
;2104:		Cmd_Say_f (ent, SAY_INVAL, qtrue);
ADDRLP4 1024
INDIRP4
ARGP4
CNSTI4 3
...
LABELV $1094
line 2110
;2110:	else if (Q_stricmp (cmd, "god") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1099
ARGP4
...
LABELV $1097
line 2112
;2112:	else if (Q_stricmp (cmd, "notarget") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1102
ARGP4
...
LABELV $1100
line 2114
;2114:	else if (Q_stricmp (cmd, "noclip") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1105
ARGP4
...
LABELV $1103
line 2116
;2116:	else if (Q_stricmp (cmd, "kill") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1108
ARGP4
...
LABELV $1106
line 2118
;2118:	else if (Q_stricmp (cmd, "teamtask") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $388
ARGP4
...
LABELV $1109
line 2120
;2120:	else if (Q_stricmp (cmd, "levelshot") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1113
ARGP4
...
LABELV $1111
line 2122
;2122:	else if (Q_stricmp (cmd, "follow") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1116
ARGP4
...
LABELV $1114
line 2124
;2124:	else if (Q_stricmp (cmd, "follownext") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1119
ARGP4
...
LABELV $1117
line 2126
;2126:	else if (Q_stricmp (cmd, "followprev") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1122
ARGP4
...
LABELV $1120
line 2128
;2128:	else if (Q_stricmp (cmd, "team") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1125
ARGP4
...
LABELV $1123
line 2130
;2130:	else if (Q_stricmp (cmd, "where") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1128
ARGP4
...
LABELV $1126
line 2132
;2132:	else if (Q_stricmp (cmd, "callvote") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1131
ARGP4
...
LABELV $1129
line 2134
;2134:	else if (Q_stricmp (cmd, "vote") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1134
ARGP4
...
LABELV $1132
line 2136
;2136:	else if (Q_stricmp (cmd, "callteamvote") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1137
ARGP4
...
LABELV $1135
line 2138
;2138:	else if (Q_stricmp (cmd, "teamvote") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1140
ARGP4
...
LABELV $1138
line 2140
;2140:	else if (Q_stricmp (cmd, "gc") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1143
ARGP4
...
LABELV $1141
line 2142
;2142:	else if (Q_stricmp (cmd, "setviewpos") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1146
ARGP4
...
LABELV $1144
line 2144
;2144:	else if (Q_stricmp (cmd, "stats") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1149
ARGP4
...
LABELV $1147
line 2146
;2146:	else if (Q_stricmp (cmd, "pdg") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1152
ARGP4
...
LABELV $1150
line 2148
;2148:	else if (Q_stricmp (cmd, "dropflag") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1155
ARGP4
...
LABELV $1153
line 2150
;2150:	else if (Q_stricmp (cmd, "spawnturret") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1158
ARGP4
...
LABELV $1156
line 2152
;2152:	else if (Q_stricmp (cmd, "spawnturret2") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1161
ARGP4
...
LABELV $1159
line 2154
;2154:	else if (Q_stricmp (cmd, "spawnturret3") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1164
ARGP4
...
LABELV $1162
line 2156
;2156:	else if (Q_stricmp (cmd, "spawngen") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1167
ARGP4
...
LABELV $1165
line 2158
;2158:	else if (Q_stricmp (cmd, "spawnmc") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1170
ARGP4
...
LABELV $1168
line 2160
;2160:	else if (Q_stricmp (cmd, "spawntd") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1173
ARGP4
...
LABELV $1171
line 2162
;2162:	else if (Q_stricmp (cmd, "listplayers") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1176
ARGP4
...
LABELV $1174
line 2164
;2164:	else if (Q_stricmp (cmd, "test") == 0)
ADDRLP4 0
ARGP4
ADDRGP4 $1179
ARGP4
...
line 2167
;2166:	else
;2167:		trap_SendServerCommand( clientNum, va("print \"unknown cmd %s\n\"", cmd ) );
ADDRGP4 $1180
ARGP4
ADDRLP4 0
ARGP4
...
;2170:/*
;2171:============================
;2172:G_SendCommandToClient
;2173:Send the given command to the specified (or all) clients
;2174:Shafe - Trep - This is for the Radar
;2175:============================
;2176:*/
;2177:void G_SendCommandToClient (gentity_t *to, char *cmd)
;2178:{
line 2179
;2179:	if (to == NULL) 
ADDRFP4 0
...
;2180:	{
line 2182
;2181:		// send to all clients 
;2182:	trap_SendServerCommand ( -1, cmd );
CNSTI4 -1
ARGI4
ADDRFP4 4
INDIRP4
...
LABELV $1182
line 2185
;2184:    // send to specified client
;2185:    trap_SendServerCommand ( to-g_entities, cmd);
ADDRFP4 0
INDIRP4
CVPU4 4
ADDRGP4 g_entities
