...
line 591
;590:
;591:	trap_SetConfigstring( CS_MUSIC, s );
CNSTI4 2
ARGI4
ADDRLP4 0
INDIRP4
...
pop
line 594
;594:	trap_SetConfigstring( CS_MESSAGE, s );				// map specific message
CNSTI4 3
ARGI4
ADDRLP4 0
INDIRP4
...
line 596
;595:
;596:	trap_SetConfigstring( CS_MOTD, g_motd.string );		// message of the day
CNSTI4 4
ARGI4
ADDRGP4 g_motd+16
ARGP4
...
line 607
;606:
;607:	g_entities[ENTITYNUM_WORLD].s.number = ENTITYNUM_WORLD;
ADDRGP4 g_entities+944328
CNSTI4 1022
ASGNI4
line 608
;608:	g_entities[ENTITYNUM_WORLD].classname = "worldspawn";
ADDRGP4 g_entities+944328+532
ADDRGP4 $288
ASGNP4
line 611
;609:
;610:	// see if we want a warmup time
;611:	trap_SetConfigstring( CS_WARMUP, "" );
CNSTI4 5
ARGI4
ADDRGP4 $285
ARGP4
...
ASGNI4
line 623
;623:		trap_SetConfigstring( CS_WARMUP, va("%i", level.warmupTime) );
ADDRGP4 $291
ARGP4
ADDRGP4 level+16
INDIRI4
...
;632:/*
;633:==============
;634:G_SpawnEntitiesFromString
;635:
;636:Parses textual entity definitions out of an entstring and spawns gentities.
;637:==============
;638:*/
;639:void G_SpawnEntitiesFromString( void ) {
line 641
;640:	// allow calls to G_Spawn*()
;641:	level.spawning = qtrue;
ADDRGP4 level+4516
CNSTI4 1
ASGNI4
line 642
;642:	level.numSpawnVars = 0;
ADDRGP4 level+4520
CNSTI4 0
ASGNI4
line 647
;643:
;644:	// the worldspawn is not an actual entity, but it still
;645:	// has a "spawn" function to perform any global setup
;646:	// needed by a level (setting configstrings or cvars, etc)
;647:	if ( !G_ParseSpawnVars() ) {
ADDRLP4 0
...
NEI4 $350
line 648
;648:		G_Error( "SpawnEntities: no entities" );
ADDRGP4 $352
ARGP4
ADDRGP4 G_Error
CALLV
...
;651:
;652:	// parse ents
;653:	while( G_ParseSpawnVars() ) {
line 654
;654:		G_SpawnGEntityFromSpawnVars();
...
line 657
;656:
;657:	level.spawning = qfalse;			// any future calls to G_Spawn*() will be errors
ADDRGP4 level+4516
CNSTI4 0
ASGNI4
line 658
