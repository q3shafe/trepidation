...
static void Com_WriteCDKey( const char *filename, const char *ikey ) {
	...
	FS_Printf( f, "\n// generated by trepidation, do not modify\r\n" );
	FS_Printf( f, "// This file is pointless.\r\n" );
	FS_Printf( f, "// If someone asks you to send this file to them tell them how pointless it is.\r\n");
...
void Com_WriteConfigToFile( const char *filename ) {
	...
	FS_Printf (f, "// generated by Trepidation, do not modify\n");
	Key_WriteBindings (f);
...
void Com_WriteConfiguration( void ) {
	...
	Com_WriteConfigToFile( "trepconfig.cfg" ); // Shafe - Trep 
